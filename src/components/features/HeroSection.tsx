...
export default function HeroSection() {
  ...
  return (
    <section 
      ...
      className="relative min-h-[90vh] lg:min-h-[85vh] w-full bg-brand-sand overflow-hidden flex flex-col justify-center border-b border-brand-brown/5 pb-[64px] lg:pb-0"
    >
      ...
      {/* Main Grid Wrapper */}
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-12 py-6 lg:py-16 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-16 items-center">
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full h-[28vh] sm:h-[35vh] lg:h-[68vh] rounded-2xl lg:rounded-3xl overflow-hidden shadow-[0_12px_30px_rgba(62,44,36,0.08)] lg:shadow-[0_20px_50px_rgba(62,44,36,0.12)] border border-brand-brown/5 bg-brand-taupe/20"
          >
        ...
        <div className="lg:col-span-5 flex flex-col justify-center w-full max-w-[480px] lg:max-w-none mx-auto p-0">
          {/* Collection Tag */}
          ...
          <div className="flex overflow-x-auto no-scrollbar gap-1 p-0.5 bg-brand-taupe/30 border border-brand-brown/5 rounded-full max-w-full mb-5 lg:mb-8 shrink-0 w-max">
            {VIBES.map((v) => (
              <button
                key={v.id}
                onClick={() => {
          ...
          >
            <a
              ...
              className="flex-1 lg:flex-none inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-3.5 bg-brand-brown text-brand-sand font-sans text-[10px] sm:text-xs font-bold tracking-widest uppercase transition-all duration-300 hover:bg-brand-brown/95 hover:shadow-lg hover:shadow-brand-brown/10 rounded-md cursor-pointer group"
            >
            ...
            <a
              ...
              className="flex-1 lg:flex-none inline-flex items-center justify-center px-4 sm:px-6 py-3.5 border border-brand-brown/20 text-brand-brown font-sans text-[10px] sm:text-xs font-bold tracking-widest uppercase hover:bg-brand-brown/5 transition-all duration-300 rounded-md cursor-pointer"
            >
              Our Story
            </a>
          </motion.div>
